 ...
 */
/*
Plugin Name: Cart2Cart: Jigoshop to WooCommerce Migration Module
Plugin URI: https://www.shopping-cart-migration.com/
...
function cart2cart_config(){
	...
	$sourceCartName = 'Jigoshop';
  $sourceCartId = 'Jigoshop';
  $sourceCartUrl = 'jigoshop';
	$referertext = 'Cart2Cart: '. $sourceCartName  . ' to '. $cartName  . ' module';
	$sourceCartLogo = 'https://www.shopping-cart-migration.com/images/stories/'.strtolower($sourceCartId).'.gif';
	$banner = '<div class="banner" onclick="javascript: window.open(\'https://www.shopping-cart-migration.com/support-service-plans/?utm_source=' . $cartName . '&utm_medium=Plugins\',\'_blank\'); return false;"><img src="'. plugins_url( 'images/banner.png' , __FILE__ ).'" /></div>';
	$cart2cart_logo = '<a target="_blank" class="cart2cart_logo" href="https://www.shopping-cart-migration.com/?utm_source=' . $cartName . '&utm_medium=Plugins&utm_campaign=c2c' . $cartName . '"  target="_blank">';
